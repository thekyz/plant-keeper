...
[![Coverage Status](https://coveralls.io/repos/github/thekyz/plant-keeper/badge.svg?branch=main&v=2)](https://coveralls.io/github/thekyz/plant-keeper?branch=main)
...
- `Makefile` includes `make coverage-lcov` to export `coverage/lcov.info` for CI integrations like Coveralls, excluding UI shell/runtime-only files and enforcing `COVERAGE_LCOV_MIN` (default `90`).
